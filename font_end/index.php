...
<body>
  ...
  <div class="bannerTop">
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="item active">
          <img src="../img1/bn5.jpg" alt="" style="width:100%;">
        </div>
        <div class="item">
          <img src="../img1/banner.png" alt="" style="width:100%;">
        </div>
        
        <div class="item">
          <img src="../img1/bn4.jpg" alt="" style="width:100%;">
        </div>
        <div class="item">
          <img src="../img1/bn2.jpg" alt="" style="width:100%;">
        </div>
      </div>
    ...
    <div class="banright">
      <ul class="ban">
        <li>
          <a href="#"><img src="../img1/right_banner1-1.png" alt="" srcset=""></a>
        </li>
        <li>
          <a href="#"><img src="../img1/right_banner2.png" alt="" srcset=""></a>
        </li>
      </ul>
      <div class="bannerto">
        <img src="../img1/banner_to.jpg" alt="" srcset="">
      </div>
    </div>
  </div>
  ...
  <div class="bannermain1">
    <a href="#"><img src="../img1/banner-main.jpg" alt="" srcset=""></a>
  </div>
  <!-- Banner-end -->
  ...
  <div class="box-common">
    <div class="first-row">
      <div class="name-product">
        <h4>Thời trang nam nổi bật nhất</h4>
      </div>
      <div class="list-featured-product">
        <ul>
          <?php
    ...
    <div class="first-row">
      <div class="name-product">
        <h4>Thời trang nữ nổi bật nhất</h4>
      </div>
      <div class="list-featured-product">
        <ul>
          <?php
        ...
        while ($row = mysqli_fetch_assoc($query)) { ?>
          <div class="item_sp">
            <a style="text-decoration: none; color: black;" href="ctsanpham.php?id=<?= $row['id_pr'] ?>">
              ...
              <h3 class="ten" style="height: 40px;"><?= $row['title'] ?></h3>
              <div class="box-p">
                <p class="price-old"><?= number_format($row['price_old'], 0, ",", "."); ?> đ</p>
                <span class="percent">-15%</span>
              </div>
    ...
    <div class="first-row">
      ...
      <div class="list-featured-product">
        <ul>
          <?php
          $sql = "SELECT * FROM product, categroy WHERE product.id_category = categroy.id_cate and id_cate = 5 LIMIT 2";
          $result = executeResult($sql);
    ...
    <div class="box-common_main">
      ...
      <div class="listproduc2" data-size="10">
        <?php
        $sql = "SELECT * FROM product WHERE product.id_category=5 ORDER BY product.id_pr ASC LIMIT 10";
        $query = mysqli_query($connect, $sql);
        while ($row = mysqli_fetch_assoc($query)) { ?>
