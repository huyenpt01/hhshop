...
if (isset($_POST['sbm'])) {
    ...
    if($title== "" || $price_old== "" || $price== ""  ){
        $_SESSION['alert'] = "Không được bỏ trống thông tin!";
    } 
    else if ($price_old < $price ) {
        // code...
        $_SESSION['alert'] = "Giá cũ không được nhỏ hơn giá khuyến mãi!";
    }
    else {
    ...
    //  header('location: ?page_layout=list_product');
    }
}
?>
